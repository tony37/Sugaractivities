...
["4746","Fractionauts","activity-fractionauts.svg","Fractionauts-2.xo","Fractionauts is an educational game for the XOPC that teaches fraction operations with rockets"],
...
["4285","Java","activity-java.svg","Java-4.xo","Provides an easy way to install the Sun Java Runtime Environment (JRE) in Sugar. "],
["4045","Jukebox","activity-jukebox.svg","Jukebox-34.xo","Jukebox is a media player to play different kinds of audio and video files","help/jukebox.html"],
...
var gtk3x = [
["4498","Across and Down","activity-acrossanddown.svg","AcrossandDown-25.xo",""],
["4419","Agu Browser","activity-agubrowser.svg","AguBrowser-4.xo",""],
...
["4406","Cave Story","activity-cavestory.svg","CaveStory-2.xo","A fun, retro-style platform game wth a great plot! Only for 32-bit x86 systems (XO-1/XO-1.5/Magallanes)."],
["4488","Fraction Bounce","activity-fractionbounce.svg","FractionBounce-25.xo",""],
["4261","Gmail","activity-gmail.svg","Gmail-2.xo",""],
["4252","Guido van Robot","activity-guidovanrobot.svg","GuidovanRobot-2.xo",""],
["4051","Help","activity-help.svg","Help-21.xo","Documentation and Help for the XO The Help activity provides a quick interface to help documentation on the XO. It launches a browser and displays html pages describing how to use the XO and the Sugar interface.","help/help.html"],
...
["4608","JClic","activity-jclic.svg","JClic-2.xo","Sugarized JClic  Sugarized JClic that needs Java: http://activities.sugarlabs.org/en-US/sugar/addon/4285 "],
["4483","Kiwix","activity-kiwix.svg","Kiwix-10.xo","Offline Wikipedia reader using the ZIM file format."],
["4729","MakeyMakey","activity-makeymakey.svg","MakeyMakey-2.xo","MakeyMakey enables the MakeyMakey device on the OLPC XO 4 hardware. Run this activity, use your MakeyMalkey device."],
...
["4303","MathGraph 32","activity-mathgraph32.svg","MathGraph32-18.xo",""],
["4230","Micropolis","activity-micropolis.svg","Micropolis-9.xo","Micropolis. Just like SimCity.Build a City. Manage your city. Pure fun! "],
["4654","Music Keyboard","activity-musickeyboard.svg","MusicKeyboard-11.xo","","help/musickeyboard.html"],
["4378","PyDebug","activity-pydebug.svg","PyDebug-8.xo","PyDebug is a tool for writing and debugging Activities for the Sugar desktop platform that is optimized for offline, stand alone program development on the XO."],
["4192","Ruler","activity-ruler.svg","Ruler-34.xo","Ruler is a very simple Activity which provides images of a ruler, cm and mm grids, and a cm checker board.  Originally written by Mictchell N. Charity for the OLPC XO-1 computer, Ruler now tries to properly calculate the proper scale for variable resolution displays. "],
...
["4084","SocialCalc","activity-socialcalcactivity.svg","socialcalcactivity-8.xo","SocialCalc is a spreadsheet activity developed in JavaScript for functioning in the Sugar environment,"],
["4802","Sugar Labs Academy","activity-sugarlabsacademy.svg","SugarLabsAcademy-3.6.xo",""],
["4311","Vnc Launcher","activity-vnclauncher.svg","VncLauncher-7.xo",""],
]
...
["4698","espiritualidad_para_ni__os_1","activity-espiritualidadparaninos1.svg","espiritualidad_para_ni__os_1-1.xo","nodesc"], 
["4699","espiritualidad_para_ni__os_2","activity-espiritualidadparaninos2.svg","espiritualidad_para_ni__os_2-1.xo","nodesc"], 
["4700","espiritualidad_para_ni__os_3","activity-espiritualidadparaninos3.svg","espiritualidad_para_ni__os_3-1.xo","nodesc"], 
["4701","espiritualidad_para_ni__os_4","activity-espiritualidadparaninos4.svg","espiritualidad_para_ni__os_4-1.xo","nodesc"], 
["4702","espiritualidad_para_ni__os_5","activity-espiritualidadparaninos5.svg","espiritualidad_para_ni__os_5-1.xo","nodesc"], 
["4703","espiritualidad_para_ni__os_6","activity-espiritualidadparaninos6.svg","espiritualidad_para_ni__os_6-1.xo","nodesc"], 
["4030","Etoys","activity-etoys.svg","etoys-113.xo","Media authoring environment with graphical scripting for children of all ages."], 
...
["4284","Geogebra","activity-geogebra.svg","geogebra-7.xo","Dynamic Mathematics for Everyone GeoGebra is dynamic mathematics software for all levels of education that joins arithmetic, geometry, algebra and calculus."], 
...
["4241","OO4kids","activity-ooo4kids.svg","ooo4kids-3.xo","Office suite for the 7-12, to create texts, presentations, calcsheets and draws, fully OpenOffice.org and MS Office compatible.","","notes/OO4Kids-Fr.html"], 
...
["4547","simple_english_wikipedia","activity-simpleenglishwikipedia.svg","simple_english_wikipedia-37.1.xo","This is a offline version of the Simple English Wikipedia, with more than 90.000 articles."], 
...
["4679","spirituality_for_kids_1","activity-spiritualityforkids1.svg","spirituality_for_kids_1-3.xo","Spirituality for Kids (Part 1) This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com."], 
["4680","spirituality_for_kids_2","activity-spiritualityforkids2.svg","spirituality_for_kids_2-3.xo","Spirituality for Kids (Part 1) This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com."], 
["4681","spirituality_for_kids_3","activity-spiritualityforkids3.svg","spirituality_for_kids_3-3.xo","Spirituality for Kids (Part 1) This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com."], 
["4684","spirituality_for_kids_4","activity-spiritualityforkids4.svg","spirituality_for_kids_4-3.xo","Spirituality for Kids (Part 1) This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com."], 
["4686","spirituality_for_kids_5","activity-spiritualityforkids5.svg","spirituality_for_kids_5-3.xo","Spirituality for Kids (Part 1) This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com."], 
["4685","spirituality_for_kids_6","activity-spiritualityforkids6.svg","spirituality_for_kids_6-3.xo","Spirituality for Kids (Part 1) This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com This activity presents a series of videos and associated activities from http://www.spiritualityforkids.com."], 
...
["4401","wikipedia","activity-wikipedia.svg","wikipedia-36.xo","WikiBrowse is a self-contained browsable offline wikireader for the Spanish Wikipedia."], 
["4631","wikipediapt","activity-wikipedia-pt.svg","wikipedia_pt-35.xo","Wikipedia in Portuguese."], 
["4411","wikipediaen","activity-wikipedia-en.svg","wikipediaen-36.xo","This is a offline version of the english Wikipedia. This is a offline version of the English Wikipedia."], 
["4540","wikipediafr","activity-wikipedia-fr.svg","wikipediafr-36.xo","A French wikipedia activity. Includes 22.100 articlesA French wikipedia activity. Includes 22.100 articles. Thanks to Hervé Odiard and Laura de Reynal,who selected articles and did quality control."], 
["4632","wikipediahi","activity-wikipedia-hi.svg","wikipediahi-35.xo","This is a offline wikipedia activity with content in Hindi language."], 
["4535","wikipediapl","activity-wikipedia-pl.svg","wikipediapl-33.3.xo","This is a offline version of the Polish Wikipedia, with more than 48.000 articles and 2900 images This is a offline version of the Polish Wikipedia, with more than 48.000 articles and 2900 images"], 
["4536","wikipediaqu","activity-wikipedia-qu.svg","wikipediaqu-33.3.xo","This is a Quechua Wikipedia activity. This is a Quechua Wikipedia activity. Include all the articles and images in the wikipedia qu version."], 
["4532","wikipediarw","activity-wikipedia-rw.svg","wikipediarw-33.3.xo","This activity include all the articles and images in the Kinyarwanda Wikipedia.  This activity include all the articles and images in the Kinyarwanda Wikipedia."], 
...
["4651","gvsig_batovi_map_viewer","activity-gvsigviewer.svg","gvsig_batovi_map_viewer-5.xo","nodesc","","notes/gvsig_batovi_map_viewer.html"], 
...
["4474","JamCalibre","activity-jamcalibre.svg","jamcalibre-2.xo","nodesc","","notes/JamCalibre.html"], 
...
["4440","OO4Kids-Fr","activity-ooo4kidsfr.svg","ooo4kidsfr-3.xo","OOo4KidsFr - OpenOffice for Kids. This is the French version of OOo4Kids","","notes/OO4Kids-Fr.html"], 
...
["4502","skype","activity-skype.svg","skype-1.xo","nodesc","","notes/skype.html"], 
...
["4088","TuxPaint","activity-tuxpaint.svg","tux_paint-6.xo","Tux Paint is a drawing app for tiny kids. Tux Paint features Tux the penguin.","","notes/TuxPaint.html"], 
...
["4630","vp__vonskeet_productions_","activity-vpvonskeetproductions.svg","vp__vonskeet_productions_-1.xo","nodesc","","notes/vp_vonskeet_productions.html"], 
["4675","word_dimensions","activity-worddimensions.svg","word_dimensions-55.xo","Word Dimensions is a pattern-matching game. The object of the game is to find sets of three cards where each attribute—color, semantic category, and word—are either the same or different.","","notes/word_dimensions.html"], 
...
var issues = [
["I","4415","activity-blender.svg","blender-12.xo"],
["I","4363","activity-.svg",""],
["I","4077","activity-newbery.svg","newbery-1.xo"],
["I","4081","activity-record.svg","record-102.xo"],
["I","4246","activity-visualmatch.svg","visual_match-49.xo"],
]
